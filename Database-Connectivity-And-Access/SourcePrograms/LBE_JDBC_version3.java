...
// Updated September 25 to use a prepaired statement for the delete function
// New method is the very last method of this code.
//     public int deleteRecord2()
// that deleteRecord2() is the last method above the main method

// c:\classes3\mysql-connector-j-8.1.0.jar
...
public class LBE_JDBC_version3 extends JFrame{
	...
	/* Define Data Source */
//Mac computers can not have this final
	String url = "jdbc:mysql://localhost/studentdb";

	/**
	 *	Constructor
	 */
	public LBE_JDBC_version3() {
		// build the GUI here
		super("JDBC Demo");
		setSize(630,400);
		setLocation(650,350);
...
//    Mac Computers        
            url = url + "?serverTimezone=UTC"; //added September 6
	...
	// 4) Create a resultset
			...
			JOptionPane.showMessageDialog(null, "Driver is " + driver,
	...
	// 6) Retrieve resultset data
		...
		// deleteRecord();
        int result = deleteRecord2();
        System.out.println("result after deleteRecord2() is: "+result);
...
public void deleteRecord() {
   ...
   public int deleteRecord2() {
	...
	public static void main(String [] args)
	{
		...
		System.out.println("ISTE330-02  PE02   Habermas, Jim  Fall 2023 Version 8.1\n");
	    // Replace Habermas and Jim with your Lastname and firstname
		new LBE_JDBC_version3();
