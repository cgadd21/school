...
public class PracticeExam2Presentation extends JFrame
{
    PracticeExam2Database dl = new PracticeExam2Database();
    ...
    public PracticeExam2Presentation()
    {
        super("Practice Exam 2");
		setSize(630,600);
		setLocation(200,380);
        ...
        JButton jbCol = new JButton("Column Count");
        jbCol.setFont(myButtonFont);
        jbCol.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae) {
				getColumnCount();
			}
		});
        ...
        JButton jbRow = new JButton("Row Count");
        jbRow.setFont(myButtonFont);
        jbRow.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae) {
				getRowCount();
			}
		});
        ...
        JButton jbGet = new JButton("Get Passengers");
        jbGet.setFont(myButtonFont);
    ...
    {
        int col = dl.getColumnCount();
        JOptionPane.showMessageDialog(null, col, "Column Count",JOptionPane.PLAIN_MESSAGE);
    }

    public void getRowCount()
    {
        int row = dl.getRowCount();
        JOptionPane.showMessageDialog(null, row, "Row Count",JOptionPane.PLAIN_MESSAGE);
    }

    public void getPassengers()
    {
        String msg = dl.getPassengers();
        JOptionPane.showMessageDialog(null, msg, "Get Passengers",JOptionPane.PLAIN_MESSAGE); 
    }
