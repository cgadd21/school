...
public class PracticeExam1Presentation extends JFrame
{
    PracticeExam1Database dl = new PracticeExam1Database();
    ...
    public PracticeExam1Presentation()
    {
        super("Practice Exam 1");
		setSize(630,400);
		setLocation(200,380);
    ...
    public void connect()
    {
        ...
        int col = dl.connect(databaseName, userName,password);
        System.out.println("You have connected to the database!\n\t\tGadd, Cooper");
        System.out.println(col + " <- Number of columns");
    }
